...
public class FirstTime extends Activity {
    ...
    public void gopotato(View view1) {
        //startActivity(new Intent(this,potato.class));
        Intent intent1 = new Intent(this, potato.class);
    ...
    public Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("FirstTime Page") // TODO: Define a title for the content shown.
